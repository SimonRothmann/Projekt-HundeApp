  ...
  return (
    ...
    <div id={id} className={cn("flex flex-wrap items-center justify-between gap-2", className)}>
      <h2 className="flex min-w-0 items-center gap-2 font-heading text-lg font-semibold tracking-tight">
        <span
          className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-primary/12 text-primary-text ring-1 ring-primary/20 dark:bg-primary/18 dark:ring-primary/35"
          aria-hidden
        >
