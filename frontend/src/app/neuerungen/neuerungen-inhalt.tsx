    ...
    <div className="flex min-h-full min-w-0 flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4">
        <section className="py-10 sm:py-14">
          <h1 className="text-3xl font-extrabold tracking-tight text-balance sm:text-4xl">{t("Neuerungen")}</h1>
          <p className="mt-3 text-base text-muted-foreground">
            {t("Dogity wird laufend weiterentwickelt. Hier steht, was sich wann geändert hat – und welche Fassung gerade läuft.")}
          </p>
            ...
            <article key={hinweis.version} className="min-w-0">
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                ...
                <time dateTime={hinweis.datum} className="text-sm text-muted-foreground">
                  {formatiereVeroeffentlichung(hinweis.datum, sprache)}
                </time>
        ...
        <section className="border-t border-border/60 py-8">
          <p className="text-sm text-muted-foreground">
            {t("Die Einträge bis einschließlich Version {v} sind nachträglich aus der Entwicklungsgeschichte zusammengetragen. Die Daten stimmen, die Einteilung in Fassungen ist im Nachhinein gezogen. Ab der nächsten Fassung entsteht jeder Eintrag zusammen mit der Änderung selbst.", { v: NACHTRAEGLICH_BIS })}
          </p>
          <p className="mt-3 text-sm text-muted-foreground">
            {t("{app} ist kostenlos und werbefrei. Rückmeldungen und Wünsche sind willkommen.", { app: SITE.name })}
          </p>
        </section>
      </main>
