...
internal static class GroupTrainingStarterCatalog
{
    ...
    [
        // ---------------- Welpen ----------------
        new(Welpen, "Begrüßung & ruhiges Ankommen", "Sozialisierung", 8,
        ...
        new(Junghunde, "Bleib mit Ablenkung", "Impulskontrolle", 8,
        ...
        new(Basis, "Sitz / Platz / Steh aus der Bewegung", "Grundsignale", 10,
            ...
            GroupExamTarget.BH | GroupExamTarget.IBGH1),
        new(Basis, "Ablegen unter Ablenkung", "Impulskontrolle", 10,
