...
- **P4b – Scheduler:** offen. `BackgroundService`, der wöchentlich die kommende Woche aktiver Ziele regeneriert. Offene Design-Entscheidung: Zeitanker „welche Woche ist aktuell?" (Goal.CreatedAt vs. neues Feld) + wie aggressiv (nur zukünftige, unbegonnene Wochen anfassen).
