...
- **P5 – Frontend (Kern):** ✅ erledigt. `reason` im DTO/Type gesurfaced; **Grund-Badges** (Schwäche/Wiederholung/Neu) je Übung; **„Neu generieren"-Button** pro Woche (ruft `regenerate-week`). Offen (P5b): Ziel-Konfig-UI (Übungen/Woche, Trainingstage) + tages-gruppierte Wochenansicht + Benachrichtigung.
